...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('alte') }}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="/data-utama" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="/data-bdh" class="nav-link">
